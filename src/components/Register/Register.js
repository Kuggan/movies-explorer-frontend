        ...
        <section className="register">
            ...
            <form className="register__form auth__form" onSubmit={handleRegister}>
                <fieldset className="register__fields auth__fields">
                    ...
                    <input type="email" name="email" className="register__input auth__input" autoComplete="on"
                    ...
                    <input type="password" name="password" className="register__input auth__input" autoComplete="on"
